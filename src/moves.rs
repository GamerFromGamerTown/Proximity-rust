...
impl Game {
    ...
    fn make_gui_move(&mut self, player: Player) {
        self.display(false);
        loop {
            println!(
                "Please choose an X and Y to place the tile. Add a comma afterwards, too. Example: 5,3, \n Your roll is {}",
